...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "chal_size"
  ipgui::add_param $IPINST -name "resp_size"

}

proc update_PARAM_VALUE.chal_size { PARAM_VALUE.chal_size } {
	# Procedure called to update chal_size when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.chal_size { PARAM_VALUE.chal_size } {
	# Procedure called to validate chal_size
	return true
}

proc update_PARAM_VALUE.resp_size { PARAM_VALUE.resp_size } {
	# Procedure called to update resp_size when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.resp_size { PARAM_VALUE.resp_size } {
	# Procedure called to validate resp_size
	return true
}
...
proc update_MODELPARAM_VALUE.chal_size { MODELPARAM_VALUE.chal_size PARAM_VALUE.chal_size } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.chal_size}] ${MODELPARAM_VALUE.chal_size}
}

proc update_MODELPARAM_VALUE.resp_size { MODELPARAM_VALUE.resp_size PARAM_VALUE.resp_size } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.resp_size}] ${MODELPARAM_VALUE.resp_size}
}
