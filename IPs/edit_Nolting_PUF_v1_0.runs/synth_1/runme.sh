...
HD_PWD='/home/puftester/PhD/repo/Hw-designs/IPs/edit_Nolting_PUF_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nolting_PUF_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nolting_PUF_v1_0.tcl
