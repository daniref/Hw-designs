...
--Date        : Fri Sep 20 17:26:59 2024
--Host        : puftester-Latitude-E7240 running 64-bit Ubuntu 18.04.6 LTS
--Command     : generate_target u96v2_4x4_apuf_wrapper.bd
...
entity u96v2_4x4_apuf_wrapper is
  port (
...
end u96v2_4x4_apuf_wrapper;

architecture STRUCTURE of u96v2_4x4_apuf_wrapper is
  component u96v2_4x4_apuf is
  port (
    ls_mezz_uart0_rx : in STD_LOGIC;
    ls_mezz_uart0_tx : out STD_LOGIC;
    ls_mezz_uart1_rx : in STD_LOGIC;
  ...
  end component u96v2_4x4_apuf;
begin
u96v2_4x4_apuf_i: component u96v2_4x4_apuf
     port map (
      bt_ctsn => bt_ctsn,
