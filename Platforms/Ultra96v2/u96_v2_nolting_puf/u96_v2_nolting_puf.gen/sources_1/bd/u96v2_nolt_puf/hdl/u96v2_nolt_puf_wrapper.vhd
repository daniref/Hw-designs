...
--Command     : generate_target u96v2_nolt_puf_wrapper.bd
...
entity u96v2_nolt_puf_wrapper is
  port (
...
end u96v2_nolt_puf_wrapper;

architecture STRUCTURE of u96v2_nolt_puf_wrapper is
  component u96v2_nolt_puf is
  port (
    ls_mezz_uart0_rx : in STD_LOGIC;
    ls_mezz_uart0_tx : out STD_LOGIC;
    ls_mezz_uart1_rx : in STD_LOGIC;
  ...
  end component u96v2_nolt_puf;
begin
u96v2_nolt_puf_i: component u96v2_nolt_puf
     port map (
      bt_ctsn => bt_ctsn,
