...
entity u96_v2_tima_ropuf2_wrapper is
  port (
...
end u96_v2_tima_ropuf2_wrapper;

architecture STRUCTURE of u96_v2_tima_ropuf2_wrapper is
  component u96_v2_tima_ropuf2 is
  port (
    ls_mezz_uart0_rx : in STD_LOGIC;
    ls_mezz_uart0_tx : out STD_LOGIC;
    ls_mezz_uart1_rx : in STD_LOGIC;
  ...
  end component u96_v2_tima_ropuf2;
begin
u96_v2_tima_ropuf2_i: component u96_v2_tima_ropuf2
     port map (
      bt_ctsn => bt_ctsn,
