...
--Command     : generate_target u96v2_myarbpuf_wrapper.bd
...
entity u96v2_myarbpuf_wrapper is
  port (
...
end u96v2_myarbpuf_wrapper;

architecture STRUCTURE of u96v2_myarbpuf_wrapper is
  component u96v2_myarbpuf is
  port (
    ls_mezz_uart0_rx : in STD_LOGIC;
    ls_mezz_uart0_tx : out STD_LOGIC;
    ls_mezz_uart1_rx : in STD_LOGIC;
  ...
  end component u96v2_myarbpuf;
begin
u96v2_myarbpuf_i: component u96v2_myarbpuf
     port map (
      bt_ctsn => bt_ctsn,
