...
################################################################
# This is a generated script based on design: u96_v2_4tima_ropuf2
#
...
# source u96_v2_4tima_ropuf2_script.tcl
...
set design_name u96_v2_4tima_ropuf2
...
proc create_root_design { parentCell } {
  ...
  # Create instance: tima_ro_0, and set properties
  set tima_ro_0 [ create_bd_cell -type ip -vlnv user.org:user:tima_ro:2.0 tima_ro_0 ]
  set_property -dict [ list \
   CONFIG.abs_pos {X0Y0} \
   CONFIG.offset_pos {90} \
 ] $tima_ro_0

  # Create instance: tima_ro_1, and set properties
  set tima_ro_1 [ create_bd_cell -type ip -vlnv user.org:user:tima_ro:2.0 tima_ro_1 ]
  set_property -dict [ list \
   CONFIG.abs_pos {X0Y20} \
   CONFIG.offset_pos {90} \
 ] $tima_ro_1

  # Create instance: tima_ro_2, and set properties
  set tima_ro_2 [ create_bd_cell -type ip -vlnv user.org:user:tima_ro:2.0 tima_ro_2 ]
  set_property -dict [ list \
   CONFIG.abs_pos {X0Y40} \
   CONFIG.offset_pos {90} \
 ] $tima_ro_2

  # Create instance: tima_ro_3, and set properties
  set tima_ro_3 [ create_bd_cell -type ip -vlnv user.org:user:tima_ro:2.0 tima_ro_3 ]
  set_property -dict [ list \
   CONFIG.abs_pos {X0Y60} \
   CONFIG.offset_pos {90} \
 ] $tima_ro_3
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins ps8_0_axi_periph/M08_AXI] [get_bd_intf_pins tima_ro_0/PUF_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins ps8_0_axi_periph/M09_AXI] [get_bd_intf_pins tima_ro_1/PUF_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins ps8_0_axi_periph/M10_AXI] [get_bd_intf_pins tima_ro_2/PUF_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M11_AXI [get_bd_intf_pins ps8_0_axi_periph/M11_AXI] [get_bd_intf_pins tima_ro_3/PUF_AXI]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins PWM_w_Int_0/s00_axi_aresetn] [get_bd_pins PWM_w_Int_1/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins axi_uart16550_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins ps8_0_axi_periph/M10_ARESETN] [get_bd_pins ps8_0_axi_periph/M11_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins tima_ro_0/puf_axi_aresetn] [get_bd_pins tima_ro_1/puf_axi_aresetn] [get_bd_pins tima_ro_2/puf_axi_aresetn] [get_bd_pins tima_ro_3/puf_axi_aresetn]
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tima_ro_0/PUF_AXI/PUF_AXI_reg] -force
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tima_ro_1/PUF_AXI/PUF_AXI_reg] -force
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tima_ro_2/PUF_AXI/PUF_AXI_reg] -force
  assign_bd_address -offset 0xA00B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs tima_ro_3/PUF_AXI/PUF_AXI_reg] -force
