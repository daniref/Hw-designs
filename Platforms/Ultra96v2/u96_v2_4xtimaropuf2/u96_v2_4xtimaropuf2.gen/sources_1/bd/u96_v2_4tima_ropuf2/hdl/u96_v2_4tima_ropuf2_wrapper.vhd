...
--Date        : Mon Nov 11 21:57:18 2024
--Host        : daniele-ThinkCentre-M75q-Gen-2 running 64-bit Ubuntu 18.04.1 LTS
--Command     : generate_target u96_v2_4tima_ropuf2_wrapper.bd
...
entity u96_v2_4tima_ropuf2_wrapper is
  port (
...
end u96_v2_4tima_ropuf2_wrapper;

architecture STRUCTURE of u96_v2_4tima_ropuf2_wrapper is
  component u96_v2_4tima_ropuf2 is
  port (
    ls_mezz_uart0_rx : in STD_LOGIC;
    ls_mezz_uart0_tx : out STD_LOGIC;
    ls_mezz_uart1_rx : in STD_LOGIC;
  ...
  end component u96_v2_4tima_ropuf2;
begin
u96_v2_4tima_ropuf2_i: component u96_v2_4tima_ropuf2
     port map (
      bt_ctsn => bt_ctsn,
