...
################################################################
# This is a generated script based on design: u96v2_arbutterfly
#
...
# source u96v2_arbutterfly_script.tcl
...
set design_name u96v2_arbutterfly
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ArButterfly_PUF_0, and set properties
  set ArButterfly_PUF_0 [ create_bd_cell -type ip -vlnv user.org:user:ArButterfly_PUF:1.0 ArButterfly_PUF_0 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins ArButterfly_PUF_0/PUF_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ArButterfly_PUF_0/PUF_AXI/PUF_AXI_reg] -force
