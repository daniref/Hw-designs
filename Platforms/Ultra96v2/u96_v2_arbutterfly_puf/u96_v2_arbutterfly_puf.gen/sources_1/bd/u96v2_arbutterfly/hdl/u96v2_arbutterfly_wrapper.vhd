...
--Command     : generate_target u96v2_arbutterfly_wrapper.bd
...
entity u96v2_arbutterfly_wrapper is
  port (
...
end u96v2_arbutterfly_wrapper;

architecture STRUCTURE of u96v2_arbutterfly_wrapper is
  component u96v2_arbutterfly is
  port (
    ls_mezz_uart0_rx : in STD_LOGIC;
    ls_mezz_uart0_tx : out STD_LOGIC;
    ls_mezz_uart1_rx : in STD_LOGIC;
  ...
  end component u96v2_arbutterfly;
begin
u96v2_arbutterfly_i: component u96v2_arbutterfly
     port map (
      bt_ctsn => bt_ctsn,
