...
entity u96_v2_pop_ropuf_wrapper is
  port (
...
end u96_v2_pop_ropuf_wrapper;

architecture STRUCTURE of u96_v2_pop_ropuf_wrapper is
  component u96_v2_pop_ropuf is
  port (
    ls_mezz_uart0_rx : in STD_LOGIC;
    ls_mezz_uart0_tx : out STD_LOGIC;
    ls_mezz_uart1_rx : in STD_LOGIC;
...
begin
u96_v2_pop_ropuf_i: component u96_v2_pop_ropuf
     port map (
      bt_ctsn => bt_ctsn,
