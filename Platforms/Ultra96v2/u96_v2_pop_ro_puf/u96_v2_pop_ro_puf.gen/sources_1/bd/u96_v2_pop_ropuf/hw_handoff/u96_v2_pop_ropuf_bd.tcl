...
################################################################
# This is a generated script based on design: u96_v2_pop_ropuf
#
...
# source u96_v2_pop_ropuf_script.tcl
...
set design_name u96_v2_pop_ropuf
...
proc create_root_design { parentCell } {
  ...
  # Create instance: POP_ro_puf_AXI4L_0, and set properties
  set POP_ro_puf_AXI4L_0 [ create_bd_cell -type ip -vlnv user.org:user:POP_ro_puf_AXI4L:1.0 POP_ro_puf_AXI4L_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {0.500000} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR0 {60} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR1 {50} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins POP_ro_puf_AXI4L_0/PUF_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs POP_ro_puf_AXI4L_0/PUF_AXI/PUF_AXI_reg] -force
