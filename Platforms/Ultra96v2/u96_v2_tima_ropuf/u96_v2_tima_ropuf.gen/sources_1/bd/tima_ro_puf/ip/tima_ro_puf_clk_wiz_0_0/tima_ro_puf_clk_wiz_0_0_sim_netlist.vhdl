...
-- Date        : Wed Sep 18 17:15:47 2024
-- Host        : puftester-Latitude-E7240 running 64-bit Ubuntu 18.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/puftester/PhD/repo/Hw-designs/Platforms/Ultra96v2/u96_v2_tima_ropuf/u96_v2_tima_ropuf.gen/sources_1/bd/tima_ro_puf/ip/tima_ro_puf_clk_wiz_0_0/tima_ro_puf_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : tima_ro_puf_clk_wiz_0_0
...
entity tima_ro_puf_clk_wiz_0_0_tima_ro_puf_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of tima_ro_puf_clk_wiz_0_0_tima_ro_puf_clk_wiz_0_0_clk_wiz : entity is "tima_ro_puf_clk_wiz_0_0_clk_wiz";
end tima_ro_puf_clk_wiz_0_0_tima_ro_puf_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of tima_ro_puf_clk_wiz_0_0_tima_ro_puf_clk_wiz_0_0_clk_wiz is
  signal clk_in1_tima_ro_puf_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_tima_ro_puf_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_tima_ro_puf_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_tima_ro_puf_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out4_tima_ro_puf_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out5_tima_ro_puf_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out6_tima_ro_puf_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out7_tima_ro_puf_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_tima_ro_puf_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_tima_ro_puf_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_tima_ro_puf_clk_wiz_0_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_tima_ro_puf_clk_wiz_0_0,
      O => clk_out3
    );
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out4_tima_ro_puf_clk_wiz_0_0,
      O => clk_out4
    );
clkout5_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out5_tima_ro_puf_clk_wiz_0_0,
      O => clk_out5
    );
clkout6_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out6_tima_ro_puf_clk_wiz_0_0,
      O => clk_out6
    );
clkout7_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out7_tima_ro_puf_clk_wiz_0_0,
      O => clk_out7
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_tima_ro_puf_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_tima_ro_puf_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_tima_ro_puf_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_tima_ro_puf_clk_wiz_0_0,
      CLKOUT2B => NLW_mmcme4_adv_inst_CLKOUT2B_UNCONNECTED,
      CLKOUT3 => clk_out4_tima_ro_puf_clk_wiz_0_0,
      CLKOUT3B => NLW_mmcme4_adv_inst_CLKOUT3B_UNCONNECTED,
      CLKOUT4 => clk_out5_tima_ro_puf_clk_wiz_0_0,
      CLKOUT5 => clk_out6_tima_ro_puf_clk_wiz_0_0,
      CLKOUT6 => clk_out7_tima_ro_puf_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity tima_ro_puf_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    clk_out3 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of tima_ro_puf_clk_wiz_0_0 : entity is true;
end tima_ro_puf_clk_wiz_0_0;

architecture STRUCTURE of tima_ro_puf_clk_wiz_0_0 is
begin
inst: entity work.tima_ro_puf_clk_wiz_0_0_tima_ro_puf_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
