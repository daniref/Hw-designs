...
HD_PWD='/home/puftester/PhD/repo/Hw-designs/PUFs/myArbPuf/myArbPuf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topArbPUF_m.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topArbPUF_m.tcl
