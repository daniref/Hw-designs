...
HD_PWD='/home/puftester/PhD/repo/Hw-designs/PUFs/myArbPuf/myArbPuf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topArbPUF_m.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topArbPUF_m.tcl -notrace
