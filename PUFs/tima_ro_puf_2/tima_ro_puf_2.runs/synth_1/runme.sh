...
HD_PWD='/home/puftester/PhD/repo/Hw-designs/PUFs/tima_ro_puf_2/tima_ro_puf_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_tima_ro_puf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_tima_ro_puf.tcl
