...
HD_PWD='/home/puftester/PhD/repo/Hw-designs/PUFs/4x4_arb_puf/4x4_arb_puf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log APUF_Driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source APUF_Driver.tcl -notrace
