...
HD_PWD='/home/puftester/PhD/repo/Hw-designs/PUFs/4x4_arb_puf/4x4_arb_puf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log APUF_Driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source APUF_Driver.tcl
