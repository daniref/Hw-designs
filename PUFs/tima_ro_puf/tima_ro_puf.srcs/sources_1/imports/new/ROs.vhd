...
constant LETTERS : string(0 to 7) := "ABCDEFGH";
...
architecture Behavioral of ROs is
 ...
 --   attribute U_SET of INVERTERS_BLK : label is "u1";
    ...
    attribute BEL of NAND_IN : label is LETTERS(0) & "6LUT";
    ...
    attribute BEL of INVERTER_0 : label is LETTERS(1) & "6LUT";
...
-------------------------------------------------------------------------------------------------------
    ...
    --    attribute U_SET of INVERTER : label is "u1";
        ...
        attribute BEL of INVERTER : label is LETTERS(i+1 mod 8) & "6LUT";
