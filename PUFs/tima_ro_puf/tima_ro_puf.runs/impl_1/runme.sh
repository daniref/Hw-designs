...
HD_PWD='/home/puftester/vivado_work/tima_ro_puf/tima_ro_puf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_tima_ro_puf.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_tima_ro_puf.tcl -notrace
