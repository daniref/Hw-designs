...
HD_PWD='/home/puftester/PhD/repo/Hw-designs/PUFs/Nolting_PUF/Nolting_PUF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_puf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_puf.tcl
