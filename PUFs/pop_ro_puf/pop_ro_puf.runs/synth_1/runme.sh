...
HD_PWD='/home/puftester/PhD/repo/Hw-designs/PUFs/pop_ro_puf/pop_ro_puf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_DB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_DB.tcl
